...
- Harden the desktop renderer's separate RCON-response display before claiming that its console presentation shares the CLI gateway's response-redaction boundary.
