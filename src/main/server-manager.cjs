...
const STATUS_COMPLETENESS_ROWS = Object.freeze({
  ...
  'console-and-rcon': { implementationPath: ['src/main/server-manager.cjs', 'src/main/main.cjs', 'src/cli/mss.cjs', 'src/cli/rcon-gateway.cjs', 'src/renderer/index.html'], documentationPath: ['docs/features/server-orchestration.md', 'docs/features/cli-rcon-gateway.md'], localization: { state: 'pending' }, test: { state: 'pending' }, capture: { state: 'pending' }, evidence: { state: 'in-progress', detail: 'Local console plus a protected, fixed-loopback CLI RCON gateway are implemented; runtime interaction and proof remain pending.' } },
