...
const STATUS_COMPLETENESS_ROWS = Object.freeze({
  ...
  'command-center': { implementationPath: ['src/main/command-center-registry.cjs', 'src/main/command-runtime-discovery.cjs', 'src/main/server-manager.cjs', 'src/renderer/destructive-confirmation.js', 'src/renderer/index.html', 'src/renderer/renderer.js'], documentationPath: ['docs/features/command-center.md', 'docs/features/notifications-and-confirmation.md'], localization: { state: 'pending' }, test: { state: 'pending' }, capture: { state: 'pending' }, evidence: { state: 'in-progress', detail: 'Bounded selected-JAR and explicitly requested live local-console or loopback-RCON discovery sources are wired with a reusable two-key/slider confirmation source; runtime interaction and verification remain pending.' } },
  ...
  'backups-and-updates': { implementationPath: ['src/main/server-backup-manager.cjs', 'src/main/server-manager.cjs', 'src/main/main.cjs', 'src/main/preload.cjs', 'src/renderer/destructive-confirmation.js', 'src/renderer/index.html', 'src/renderer/renderer.js'], documentationPath: ['docs/features/backups-and-paper-updates.md', 'docs/features/notifications-and-confirmation.md'], localization: { state: 'pending' }, test: { state: 'pending', detail: 'No test was run in this delivery pass.' }, capture: { state: 'pending', detail: 'No capture was run in this delivery pass.' }, evidence: { state: 'in-progress', detail: 'Bounded local snapshot, restore, Paper stable-update, rollback, and reusable two-key/slider confirmation source are registered; verification remains pending.' } },
  ...
  'docs-history-and-notifications': { implementationPath: ['src/main/notification-center.cjs', 'src/main/main.cjs', 'src/main/preload.cjs', 'src/renderer/notification-toasts.js', 'src/renderer/index.html', 'src/renderer/renderer.js'], documentationPath: ['docs/features/notifications-and-confirmation.md', 'docs/features/README.md'], localization: { state: 'in-progress', detail: 'The notification-center and toast foundation uses current presentation hooks; complete localization remains pending.' }, test: { state: 'pending', detail: 'No test was run in this delivery pass.' }, capture: { state: 'pending', detail: 'No built-artifact capture was run in this delivery pass.' }, evidence: { state: 'in-progress', detail: 'Bounded scrubbed local notification persistence, a user-opened review center, selection/bulk-action groundwork, and non-blocking toast source are registered; complete documentation, history, export, and verification remain pending.' } },
