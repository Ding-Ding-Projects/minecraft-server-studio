...
contextBridge.exposeInMainWorld('studio', {
  ...
  pullOllamaModel: (input) => ipcRenderer.invoke('studio:ollama-pull', input),
  copyOllamaModel: (input) => ipcRenderer.invoke('studio:ollama-copy', input),
  previewOllamaModelDeletion: (input) => ipcRenderer.invoke('studio:ollama-delete-preview', input),
  deleteOllamaModel: (input) => ipcRenderer.invoke('studio:ollama-delete', input),
  cancelOllamaOperation: (input) => ipcRenderer.invoke('studio:ollama-cancel', input),
