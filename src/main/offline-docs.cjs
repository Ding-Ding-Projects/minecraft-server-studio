...
const OFFLINE_DOCUMENTATION_INVENTORY = Object.freeze([
  ...
  entry('browser-local-changelog-viewer', 'browser-local-changelog-viewer.md', 'Browser-local companion-site changelog viewer', 'Browse the committed public release catalog, filter it locally, and copy or download selected text records without a runtime release fetch.'),
